...
modal.innerHTML = '<h1> You are using the wrong browser. </h1><img src="http://fc03.deviantart.net/fs18/f/2007/137/5/0/IE_Sucks_by_boozker.png" alt="IE Sucks" title="Stop using Internet Explorer" style="margin: auto;" /><p>You are strongly encouraged to change your browser. <br />Download <a href="https://www.mozilla.org/en-US/firefox/new/" target="_blank"  style="font-weight:bold;">Firefox</a> or <a href="https://www.google.com/chrome/browser/desktop/"  target="_blank"  style="font-weight:bold;">Chrome</a>.</p><h2>Why?</h2><p>Because Microsoft doesn\'t care about web standards.</p><a href="http://www.augustin-riedinger.fr" target="_blank" style="font-weight:bold;">Read detailed article &#8594;</a>';
